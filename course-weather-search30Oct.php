	...
	<div class="flexible-width2">
		...
		<div class="flex ">
			<div class="flexible-width">
				...
				<div class="flex pt20">
					<div class="flex1"><input maxlength="20" id="searchTXT" name="searchTXT" class="search_page" placeholder="Start typing" /></div>
