	...
	<div class="flexible-width2">
		<div class="flex ">
			<div class="flexible-width">
				<div class="fcName">Share Course</div>
				<div class="infoDim mt20 f15N pb20">
					Please complete the form below to send the Weather Forecast for "<?php echo $courseName;?>" to your friends. 
				</div>
			  	<div style="float:left;width:548px;margin-left:0px;margin-top:0px">
					...
					<div class="flex pt10 f16N">
						<div class="input-icon-container mr10">
					      	<div class="fcName">Friends to Invite</div>
					    </div>
					</div>
					<div class="flex pt20 f16N">
						<div class="input-icon-container mr10">
					...
					<div class="flex pt20">
					     <button class="greenBtnPopReg" onclick="javascript:location.href='';">Send Invites</button>
					</div>
				</div>
			</div>
		</div>
...
<div class="mobidiv">
	<div class="mobiinner mBG">
		...
		<div class="f20B pt15">Share Course</div>
		<div class="mobiTxt pt15">Please complete the form below to send the Weather Forecast for "<?php echo $courseName;?>" to your friends. </div>
