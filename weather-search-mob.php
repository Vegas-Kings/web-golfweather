<?php
	...
	if(isset($searchTXT)){
		...
		if($search_area != '' && $search_area != 'Any'){
			$searchSql .= " and gr.id = ".$search_area."";
		}

		if($search_city != '' && $search_city != 'Any'){
		...
		<div class="resulOptDD pt20">
			<div class="flexUneven" style="height:40px;">
				<div class="ddCircle dropdown">
					<input type="Hidden" id="search_DDMob" name="search_DDMob" value="<?php echo $search_DD;?>" />
